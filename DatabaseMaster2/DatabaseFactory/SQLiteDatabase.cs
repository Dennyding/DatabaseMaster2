...
{
    public class SQLiteDatabase : DatabaseInterface
    {
        ...
        {
            ConnectString= XmlStream.getXmlValue(AppDomain.CurrentDomain.BaseDirectory+"DatabaseConfig.xml", "SQLite", "ConnectString");
        }
        ...
        /// </GetConnectionString>
        /// <returns></returns>
        public SQLiteDatabase(String ConnString, Boolean ConnStr)
        {
        ...
        /// </GetConnectionString>
        /// <returns></returns>
        public SQLiteDatabase(String ConnectName)
        {
        ...
        /// </GetConnectionString>
        /// <returns></returns>
        public SQLiteDatabase(String ConnectName, StringEncrypt.EncryptType type)
        {
        ...
        public Int32 ExecueCommand(String Command, ParameterINClass[] Parameter, Int32 Timeout = 30)
        {
            ...
            SQLiteParameter[] para = new SQLiteParameter[Parameter.Length];
            for (int number = 0; number < Parameter.Length; number++)
            {
                para[0] = new SQLiteParameter(Parameter[number].ParameterName, Parameter[number].SqliteDbType);
            ...
            ParameterClass[] ParameterIn, ParameterOutClass[] ParameterOut, Int32 Timeout = 30)
        {
            ...
            SQLiteCommand cmd = new SQLiteCommand(StoreProCommand, conn);
            ...
            ParameterClass[] ParameterIn, Int32 Timeout = 30)
        {
            ...
            SQLiteDataAdapter da = new SQLiteDataAdapter(StoreProCommand, conn);
            da.SelectCommand.CommandTimeout = Timeout;
