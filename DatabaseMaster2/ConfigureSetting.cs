...
namespace DatabaseMaster2
{
    ...
    public class XmlStream
    {
        ...
        /// <param name="xmlElement">指定元素</param>  
        /// <returns></returns>  
        public static string getXmlValue(String FileName, string xmlElement)
        {
            try
            {
                XDocument xmlDoc = XDocument.Load(FileName);
        ...
        /// <param name="xmlElement">指定元素</param> 
        /// <returns></returns>  
        public static string getXmlValueFromVar(string xmlElement)
        {
            try
            {
                XDocument xmlDoc = xmlDocSave;
        ...
        /// <param name="xmlElement">指定元素</param>  
        /// <param name="xmlValue">指定值</param>  
        public static Boolean setXmlValue(String FileName, string xmlElement, string xmlValue)
        {
        ...
        /// <param name="xmlValue">指定值</param>
        /// <returns></returns>
        public static Boolean setXmlValueToVar(string xmlElement, string xmlValue)
        {
