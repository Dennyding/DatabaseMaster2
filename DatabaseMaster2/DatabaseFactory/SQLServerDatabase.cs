...
{
    public class SQLServerDatabase:DatabaseInterface
    {
        ...
        {
            ConnectString= XmlStream.getXmlValue(AppDomain.CurrentDomain.BaseDirectory+"DatabaseConfig.xml", "MSSQL", "ConnectString");
        }
        ...
        /// </GetConnectionString>
        /// <returns></returns>
        public SQLServerDatabase(String ConnString, Boolean ConnStr)
        {
            ...
            ParameterClass[] ParameterIn, ParameterOutClass[] ParameterOut, Int32 Timeout = 30)
        {
            ...
            SqlCommand cmd = new SqlCommand(StoreProCommand, conn);
            ...
            ParameterClass[] ParameterIn, Int32 Timeout = 30)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(StoreProCommand, conn);
            da.SelectCommand.CommandTimeout = Timeout;
